...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-zinc-50 to-white">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-b from-blue-50/50 via-white to-white px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        <div className="container mx-auto max-w-4xl text-center">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-blue-50 px-4 py-2 text-sm font-medium text-blue-700 shadow-sm">
          ...
          <p className="mb-8 text-lg leading-relaxed text-zinc-600 sm:text-xl lg:mx-auto lg:max-w-2xl">
          ...
          <div className="mt-12 flex flex-wrap items-center justify-center gap-8 text-sm text-zinc-600">
            <div className="flex items-center gap-2">
          ...
          <div className="mt-10 grid grid-cols-2 gap-4 sm:grid-cols-4 lg:gap-6">
            <div className="flex flex-col items-center gap-2 rounded-xl bg-white/60 p-4 backdrop-blur-sm sm:p-5">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-blue-100 text-blue-600 shadow-sm">
                <Calendar className="h-6 w-6" />
              </div>
              <span className="text-center text-xs font-medium text-zinc-700 sm:text-sm">Shared Calendar</span>
            </div>
            <div className="flex flex-col items-center gap-2 rounded-xl bg-white/60 p-4 backdrop-blur-sm sm:p-5">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-green-100 text-green-600 shadow-sm">
                <CheckCircle2 className="h-6 w-6" />
              </div>
              <span className="text-center text-xs font-medium text-zinc-700 sm:text-sm">Task Management</span>
            </div>
            <div className="flex flex-col items-center gap-2 rounded-xl bg-white/60 p-4 backdrop-blur-sm sm:p-5">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-purple-100 text-purple-600 shadow-sm">
                <Bell className="h-6 w-6" />
              </div>
              <span className="text-center text-xs font-medium text-zinc-700 sm:text-sm">Smart Reminders</span>
            </div>
            <div className="flex flex-col items-center gap-2 rounded-xl bg-white/60 p-4 backdrop-blur-sm sm:p-5">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-pink-100 text-pink-600 shadow-sm">
                <Heart className="h-6 w-6" />
              </div>
              <span className="text-center text-xs font-medium text-zinc-700 sm:text-sm">Family Memories</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-4 py-16 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100/80 p-6 text-center shadow-sm transition-shadow hover:shadow-md">
              <div className="mb-4 inline-flex h-14 w-14 items-center justify-center rounded-full bg-blue-600 text-white shadow-md">
                <Sparkles className="h-7 w-7" />
              </div>
              <h3 className="mb-2.5 text-lg font-semibold text-zinc-900">Calm</h3>
              <p className="text-sm leading-relaxed text-zinc-600">
                No noisy notifications or overwhelming interfaces. Just peaceful family coordination.
              </p>
            </div>
            <div className="rounded-2xl bg-gradient-to-br from-green-50 to-green-100/80 p-6 text-center shadow-sm transition-shadow hover:shadow-md">
              <div className="mb-4 inline-flex h-14 w-14 items-center justify-center rounded-full bg-green-600 text-white shadow-md">
                <CheckCircle2 className="h-7 w-7" />
              </div>
              <h3 className="mb-2.5 text-lg font-semibold text-zinc-900">Organized</h3>
              <p className="text-sm leading-relaxed text-zinc-600">
                Everything in one place: calendar, tasks, notes, and memories. No more searching.
              </p>
            </div>
            <div className="rounded-2xl bg-gradient-to-br from-purple-50 to-purple-100/80 p-6 text-center shadow-sm transition-shadow hover:shadow-md">
              <div className="mb-4 inline-flex h-14 w-14 items-center justify-center rounded-full bg-purple-600 text-white shadow-md">
                <Bell className="h-7 w-7" />
              </div>
              <h3 className="mb-2.5 text-lg font-semibold text-zinc-900">Reliable</h3>
              <p className="text-sm leading-relaxed text-zinc-600">
                Automated WhatsApp & SMS reminders ensure nothing falls through the cracks.
              </p>
            </div>
            <div className="rounded-2xl bg-gradient-to-br from-pink-50 to-pink-100/80 p-6 text-center shadow-sm transition-shadow hover:shadow-md">
              <div className="mb-4 inline-flex h-14 w-14 items-center justify-center rounded-full bg-pink-600 text-white shadow-md">
                <Users className="h-7 w-7" />
              </div>
              <h3 className="mb-2.5 text-lg font-semibold text-zinc-900">Family-First</h3>
              <p className="text-sm leading-relaxed text-zinc-600">
      ...
      <section id="how-it-works" className="bg-white px-4 py-16 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="relative rounded-2xl bg-gradient-to-br from-white to-zinc-50 p-6 shadow-md transition-shadow hover:shadow-lg">
              <div className="mb-5 flex h-11 w-11 items-center justify-center rounded-full bg-gradient-to-br from-blue-600 to-blue-700 text-lg font-bold text-white shadow-md">
                1
              </div>
              <h3 className="mb-3 text-lg font-semibold text-zinc-900">Create Family Space</h3>
              <p className="text-sm leading-relaxed text-zinc-600">
            ...
            <div className="relative rounded-2xl bg-gradient-to-br from-white to-zinc-50 p-6 shadow-md transition-shadow hover:shadow-lg">
              ...
              <h3 className="mb-3 text-lg font-semibold text-zinc-900">Add Events & Tasks</h3>
              <p className="text-sm leading-relaxed text-zinc-600">
            ...
            <div className="relative rounded-2xl bg-gradient-to-br from-white to-zinc-50 p-6 shadow-md transition-shadow hover:shadow-lg">
              ...
              <h3 className="mb-3 text-lg font-semibold text-zinc-900">Get Reminders Automatically</h3>
              <p className="text-sm leading-relaxed text-zinc-600">
      ...
      <section className="bg-gradient-to-b from-white via-blue-50/30 to-white px-4 py-12 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-5xl">
          <div className="mb-8 text-center">
            <h2 className="mb-2 text-3xl font-bold text-zinc-900 sm:text-4xl">
              Simple & Reliable
            </h2>
          ...
          <div className="rounded-3xl bg-gradient-to-br from-white via-white to-blue-50/40 p-6 shadow-2xl sm:p-8 lg:p-10">
            <div className="relative grid gap-6 lg:grid-cols-3 lg:gap-4">
              {/* Family Members Card */}
              <div className="group relative rounded-2xl bg-gradient-to-br from-blue-50/80 to-white p-6 text-center shadow-md transition-all hover:shadow-xl hover:scale-[1.02] lg:text-left">
                <div className="mb-4 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 text-white shadow-lg transition-transform group-hover:scale-110 group-hover:rotate-3 lg:mx-0">
                  <Users className="h-7 w-7" />
                </div>
                <h3 className="mb-2.5 text-lg font-bold text-zinc-900">Family Members</h3>
                <p className="text-sm leading-relaxed text-zinc-600">
                  Access Famjam from any web browser. Simple, secure, and accessible.
                </p>
                <div className="absolute -right-3 top-1/2 hidden h-8 w-8 -translate-y-1/2 items-center justify-center rounded-full bg-white text-blue-600 shadow-lg lg:flex">
                  <ArrowRight className="h-5 w-5" />
                </div>
              </div>

              {/* Famjam Platform Card */}
              <div className="group relative rounded-2xl bg-gradient-to-br from-green-50/80 to-white p-6 text-center shadow-md transition-all hover:shadow-xl hover:scale-[1.02] lg:text-left">
                <div className="mb-4 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-green-500 to-green-600 text-white shadow-lg transition-transform group-hover:scale-110 group-hover:rotate-3 lg:mx-0">
                  <Sparkles className="h-7 w-7" />
                </div>
                <h3 className="mb-2.5 text-lg font-bold text-zinc-900">Famjam Platform</h3>
                <p className="text-sm leading-relaxed text-zinc-600">
                  Your shared dashboard with calendar, tasks, notes, memories, and smart organization.
                </p>
                <div className="absolute -right-3 top-1/2 hidden h-8 w-8 -translate-y-1/2 items-center justify-center rounded-full bg-white text-green-600 shadow-lg lg:flex">
                  <ArrowRight className="h-5 w-5" />
                </div>
              </div>

              {/* Smart Reminders Card */}
              <div className="group relative rounded-2xl bg-gradient-to-br from-purple-50/80 to-white p-6 text-center shadow-md transition-all hover:shadow-xl hover:scale-[1.02] lg:text-left">
                <div className="mb-4 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-purple-500 to-purple-600 text-white shadow-lg transition-transform group-hover:scale-110 group-hover:rotate-3 lg:mx-0">
                  <Bell className="h-7 w-7" />
                </div>
                <h3 className="mb-2.5 text-lg font-bold text-zinc-900">Smart Reminders</h3>
                <p className="text-sm leading-relaxed text-zinc-600">
            ...
            <div className="mt-8 flex items-center justify-center gap-2 text-xs font-medium text-zinc-500 lg:hidden">
      ...
      <section className="bg-zinc-50 px-4 py-16 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="rounded-2xl border border-zinc-200/50 bg-white p-6 text-center shadow-sm transition-shadow hover:shadow-md">
              <div className="mb-4 inline-flex h-14 w-14 items-center justify-center rounded-full bg-blue-100 text-blue-600 shadow-sm">
                <Lock className="h-7 w-7" />
              </div>
              <h3 className="mb-2.5 text-lg font-semibold text-zinc-900">Secure Authentication</h3>
              <p className="text-sm leading-relaxed text-zinc-600">
                Industry-standard email and password authentication with JWT tokens. Your account is protected.
              </p>
            </div>
            <div className="rounded-2xl border border-zinc-200/50 bg-white p-6 text-center shadow-sm transition-shadow hover:shadow-md">
              <div className="mb-4 inline-flex h-14 w-14 items-center justify-center rounded-full bg-green-100 text-green-600 shadow-sm">
                <Shield className="h-7 w-7" />
              </div>
              <h3 className="mb-2.5 text-lg font-semibold text-zinc-900">Private Family Data</h3>
              <p className="text-sm leading-relaxed text-zinc-600">
                Row-level security ensures only your family members can access your shared dashboard and memories.
              </p>
            </div>
            <div className="rounded-2xl border border-zinc-200/50 bg-white p-6 text-center shadow-sm transition-shadow hover:shadow-md">
              <div className="mb-4 inline-flex h-14 w-14 items-center justify-center rounded-full bg-purple-100 text-purple-600 shadow-sm">
                <Clock className="h-7 w-7" />
              </div>
              <h3 className="mb-2.5 text-lg font-semibold text-zinc-900">Modern Infrastructure</h3>
              <p className="text-sm leading-relaxed text-zinc-600">
      ...
      <section id="faq" className="bg-white px-4 py-16 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-3xl">
          ...
          <div className="space-y-4">
            <div className="rounded-2xl bg-gradient-to-br from-white to-zinc-50 p-6 shadow-sm">
              <h3 className="mb-2.5 text-lg font-semibold text-zinc-900">Is it private?</h3>
              <p className="text-sm leading-relaxed text-zinc-600">
            ...
            <div className="rounded-2xl bg-gradient-to-br from-white to-zinc-50 p-6 shadow-sm">
              <h3 className="mb-2.5 text-lg font-semibold text-zinc-900">Is it for kids & elders?</h3>
              <p className="text-sm leading-relaxed text-zinc-600">
            ...
            <div className="rounded-2xl bg-gradient-to-br from-white to-zinc-50 p-6 shadow-sm">
              <h3 className="mb-2.5 text-lg font-semibold text-zinc-900">Do I need WhatsApp?</h3>
              <p className="text-sm leading-relaxed text-zinc-600">
            ...
            <div className="rounded-2xl bg-gradient-to-br from-white to-zinc-50 p-6 shadow-sm">
              <h3 className="mb-2.5 text-lg font-semibold text-zinc-900">Is it free?</h3>
              <p className="text-sm leading-relaxed text-zinc-600">
